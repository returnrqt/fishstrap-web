...
<div class="flex items-center justify-center min-h-screen">
    <div class="text-center flex flex-col items-center justify-center">
        ...
        <svg class="mb-8" fill="#bee3f9" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            width="150px" height="150px" viewBox="0 0 106.059 106.059" xml:space="preserve">
            <g>
