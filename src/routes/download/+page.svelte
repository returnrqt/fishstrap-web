...
<div class="justify-center items-center flex pointer-events-none flex-col z-100">
    <div class="text-transparent bg-clip-text text-center bg-gradient-to-r from-astronaut-blue-300 to-astronaut-blue-700">
    ...
    <div class="animate-bounce rounded-4xl border-1 bg-[#1b1f29] p-2">
